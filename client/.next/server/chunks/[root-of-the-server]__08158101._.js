...
"[project]/.next-internal/server/app/api/auth/slide-session/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
const authApi = {
    ...
    slideSessionFromNextServerToServer: (sessionToken)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post("/auth/slide-session", {}, {
            headers: {
                Authorization: `Bearer ${sessionToken}`
            }
        });
    ...
    slideSessionFromNextClientToNextServer: ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$http$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post("/api/auth/slide-session", {}, {
            baseUrl: ""
        });
    }
};
...
"[project]/src/app/api/auth/slide-session/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST() {
    ...
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiRequest$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].slideSessionFromNextServerToServer(sessionToken.value);
        const expiresDate = new Date(res.payload.data.expiresAt).toUTCString();
        return Response.json(res.payload, {
            status: 200,
            headers: {
                "Set-Cookie": `sessionToken=${sessionToken.value}; Path=/; HttpOnly; Expires=${expiresDate};`
            }
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__08158101._.js.map